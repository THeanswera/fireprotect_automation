...
| 50 | major_axis_moment_knm | Maximum bending-moment magnitude about selected major axis | decimal | kN·m | input | conditional | Bending corpus + RX3 help + controlled RX3/LIRA evidence | confirmed | `My -> field50 / MAGNITUDE` is validated only for Б2 / 22П / ГОСТ 8240-97 / L=3.00 m / rotation=0 / one-plane X-X and one selected source row. `EXPERIMENTAL`; no envelope or global production-write claim. |
...
| 78 | persisted_major_axis_moment_copy_knm | RX3-persisted copy of the active major-axis moment | decimal | kN·m | service | conditional | Controlled one-plane post-calc differentials | probable | Derived/persisted copy only; absent from direct-writer targets and writing is forbidden. |
