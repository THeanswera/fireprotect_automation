...
записи побайтово идентичны шаблону. Не подтверждённые документацией условия
(расчётная длина, закрепление) остаются в отчёте как запрет на расчёт без
ручной сверки. Обзорный Excel учебного опыта создаётся отдельной командой
