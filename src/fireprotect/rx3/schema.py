...
FIELD_SPECS: dict[int, FieldSpec] = {
    ...
    52: _c(52, "load_level_mu0", "Load level used to determine critical temperature", units="1", direction="calculated", source="Exact EN 1993-1-2 critical-temperature relation with field44 + RX3 help", controlled_experiment_ids=("RX3-EXP-01", "RX3-EXP-01C", "RX3-EXP-01D"), reviewer_note="Three controlled axial states equal the GUI gamma_tem values after display rounding."),
    53: _c(53, "beta_tem_modulus_reduction", "RX3 beta_tem / elastic-modulus reduction coefficient at critical temperature", units="1", direction="calculated", source="RX3-EXP-01/01C/01D GUI equality + RX3 EN 1993-1-2 help", confidence="probable", comment="Three controlled axial states equal GUI beta_tem after display rounding; broader stress-state applicability and a direct exported-report binding remain unverified.", evidence_type="CONTROLLED_GUI_CORRELATION_AND_HELP", evidence_sources=("RX3-EXP-01 baseline GUI observation", "RX3-EXP-01C controlled N30 GUI observation", "RX3-EXP-01D controlled N25 GUI observation", "rx3/doc/pages/EN1993_1_2.html"), controlled_experiment_ids=("RX3-EXP-01", "RX3-EXP-01C", "RX3-EXP-01D"), reviewer_note="Promoted only from UNKNOWN to PROBABLE; remains forbidden for writes and excluded from confirmed result import."),
    54: _c(54, "unprotected_fire_resistance_min", "Calculated unprotected fire resistance", units="min", direction="output", source="RX38 values + RX3 report", controlled_experiment_ids=("RX3-EXP-01", "RX3-EXP-01C", "RX3-EXP-01D"), reviewer_note="Bidirectional axial perturbations reproduce the GUI unprotected fire resistance; normative equivalence remains outside this evidence."),
    ...
    76: _c(76, "normal_stress_mpa", "Calculated normal stress", units="MPa", direction="calculated", source="RX38 values + RX3 report", confidence="probable", comment="Three controlled axial states match the GUI stress value, but combined-stress records are not uniquely attributable.", evidence_type="CONTROLLED_GUI_CORRELATION_AND_REPORT", evidence_sources=("RX3 report", "RX3-EXP-01 baseline GUI observation", "RX3-EXP-01C controlled N30 GUI observation", "RX3-EXP-01D controlled N25 GUI observation"), controlled_experiment_ids=("RX3-EXP-01", "RX3-EXP-01C", "RX3-EXP-01D"), reviewer_note="Retained as PROBABLE and not renamed because only the axial compressed-member path is replicated."),
