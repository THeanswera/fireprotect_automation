...
FIELD_SPECS: dict[int, FieldSpec] = {
    ...
    50: _c(50, "major_axis_moment_knm", "Bending moment about selected major axis", units="kN·m", source="5-record bending corpus + RX3 help + RX3-EXP-02/02B controlled GUI evidence", required="conditional", comment="Confirmed only for one-plane bending about X-X in the verified Б1 template family; production writing remains disabled.", evidence_type="CONTROLLED_SINGLE_VARIABLE_GUI_CAUSALITY", evidence_sources=("RX3-EXP-02 five-record one-plane bending corpus", "RX3-EXP-02 Phase A GUI observation", "RX3-EXP-02B controlled field50 Mx=10 GUI/calculation/save"), controlled_experiment_ids=("RX3-EXP-02", "RX3-EXP-02B"), reviewer_note="Semantic confirmation is limited to one-plane bending about X-X in the verified Б1 template family. The LIRA axis/sign convention, other stress states and arbitrary production writing remain unverified.", write_policy=WritePolicy.EXPERIMENTAL),
    ...
    92: _c(92, "rx3_gui_q_input_kn", "RX3 GUI shear-force Q input for the verified one-plane X-X bending family", units="kN", required="conditional", source="Five-record bending correlation + RX3-EXP-02/02B/03 controlled GUI evidence", comment="Confirmed only as the RX3 GUI Q input for the verified Б1 / 14Б2 / one-plane bending / X-X family; production writing remains disabled.", evidence_type="CONTROLLED_SINGLE_VARIABLE_GUI_CAUSALITY", evidence_sources=("RX3-EXP-02 five-record bending correlation and GUI observation", "RX3-EXP-02B fixed-Q Mx perturbation: GUI Q remained 2.32 while Mx changed", "RX3-EXP-03 field92-only perturbation: GUI Q 2.32 -> 3.00 and Q utilisation 0.028 -> 0.037", "RX3-EXP-03 persisted field92 numeric 3.00 with target-aware non-target invariance"), controlled_experiment_ids=("RX3-EXP-02", "RX3-EXP-02B", "RX3-EXP-03"), reviewer_note="CONFIRMED only as RX3 GUI Q input for the verified Б1 / 14Б2 / one-plane bending / X-X family. This does not confirm LIRA Qx or Qy mapping, Q sign convention, local-axis convention, other stress states, arbitrary combined-stress semantics, or production compatibility.", write_policy=WritePolicy.EXPERIMENTAL),
